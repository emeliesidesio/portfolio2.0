  ...
  render() {
    return (
      <div className="content">
        <div className="grid">
          <div className="gridItem wide blue">
          ...
          <div className="gridItem imageSmall grey" style={{ backgroundImage: `url(${dreamcatcher})` }}></div>
          <div className="gridItem imageSmall grey" style={{ backgroundImage: `url(${cat})` }}></div>
          <div className="gridItem">
          ...
          <div className="gridItem wide white black">
          ...
          <div className="gridItem wide green">
          ...
          <div className="gridItem imageSmall pink" style={{ backgroundImage: `url(${fries})` }}></div>
          <div className="gridItem animation grey"><LottieControl /></div>
          <div className="gridItem black white">
          ...
          <div className="gridItem wide purple">
